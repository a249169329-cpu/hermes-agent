...
def invoke_tool(agent, function_name: str, function_args: dict, effective_task_id: str,
    ...
    def _finish_agent_tool(result: Any, observed_args: Optional[dict] = None) -> Any:
        try:
            ...
            logger.exception("agent-runtime tool output guard failed for %s: %s", function_name, _output_guard_err)
            result = json.dumps(
                {
                    "error": "Tool output guard failed before returning agent-runtime result",
